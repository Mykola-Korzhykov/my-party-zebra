  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="preload"
          href="/fonts/Zebra-Regular.woff2"
          as="font"
          type="font/woff2"
          crossOrigin="true"
        />
      ...
      <Provider store={store}>
        <Layout
          data={{ meta: metaData, layout: layoutData, locales: localesData }}
        >
          <Component {...pageProps} />
        </Layout>
      </Provider>
...
CustomApp.getInitialProps = async (
  ...
  return {
    ...appProps,
    env: process.env,
    props: { metaData, layoutData, localesData },
  };
};
